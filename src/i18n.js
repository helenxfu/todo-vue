...
export default new VueI18n({
  ...
  messages: {
    en: {
      ...
      table: {
        status: 'Status', titleCategory: 'Category', titleName: 'Todo Name', titleLimit: 'Deadline', titleRemain: 'Remaining', buttonEdit: 'Edit', priorityHigh: 'High', priorityMid: 'Mid', priorityLow: 'Low'
      },
      forms: {
